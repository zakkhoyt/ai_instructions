...
# ---- ---- ----  About this Script  ---- ---- ----
#
# Purpose: Test configure_ai_instructions_overhaul.zsh with comprehensive scenarios
# Author: AI Agent
# Usage: ./configure_ai_instructions_overhaul_tests.zsh [--debug]
#
# Tests the OVERHAUL version of configure_ai_instructions with critical fixes:
# - Menu always shows when --prompt set
# - Fixed number formatting for 10+ items
# - Xcode MCP only runs explicitly
# - Installation method displayed in menu
#
...
typeset -r script_to_test="./scripts/configure_ai_instructions_overhaul.zsh"
typeset -r log_dir=".gitignored/test_logs/overhaul_version"
